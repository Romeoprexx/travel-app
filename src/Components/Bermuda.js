...
import BermudaWeather from './BermudaW';
    ...
    return (
      <div className="new-york-wrapper">
          ...
          <div className='newsWrapper'>
            ...
            <div className='covidMsg'>
              ...
              <button className='btn'><span><GiWorld className='filler' /></span>
                <span className='shift'>www.gov.bm</span>
              </button>
            </div>
          </div>
        ...
        <TopPicks className="tops" id="top"
          headline={'Top Experiences in Bermuda'}
...
const AllNewYorkCityData = [
  ...
  
  {
    ...
    description:
      'Get a taste of Bermuda’s truly global culture with these delicious food tours of Bermuda. Whether you’re looking for the best Bermuda local cuisine or fancy the best craft beer from the east coast, we have got the perfect tours for you.',
    sectionData: [
      {
        id: 1,
        currentPrice: 61,
      ...
      },
      {
        ...
        cashback: null,
        about: 'FOOD AND DRINKS',
        description: 'Henderson Restaurant',
        url:
  ...
  {
    id: 4,
    headline: 'Bermuda Tours',
    description:
      'With a range of tours catering to different parts of the city, you get the chance to see some of the major attractions. Check out our list of Bermuda Tours to know more.',
    sectionData: [
      {
        id: 1,
        currentPrice: 33,
      ...
      },
      {
        ...
        about: 'BERMUDA EXPLORER PASS',
        description: 'Bermuda Explorer Pass - 3 Attractions',
        url:
      ...
      },
      {
        ...
        discount: 20,
        about: 'BERMUDA TOURS',
        description: `Bermuda in a Day`,
        url:
          'https://www.bermuda-attractions.com/bermuda_i000383.jpg'
      },
      {
        id: 4,
        currentPrice: 51,
      ...
      },
      {
        ...
        about: 'THE BERMUDA PASS',
        description: `Bermuda Unlimited Attraction Pass - 1 Day`,
        url:
          'https://lifewellcruised.com/wp-content/uploads/2019/03/16-Best-Tips-for-cruising-to-Bermuda-the-Ultimate-guide.png'
      },
      {
        id: 7,
        currentPrice: 69,
  ...
  {
    id: 7,
    headline: 'Bermuda Museums and Hotels',
    description:
      'From museums that offer knowledge about art and history to five stars hotels, Bermuda attractions have it all. Have a look at these to know more.',
    sectionData: [
      {
        id: 1,
        currentPrice: 37,
        ...
        description: 'Reginas',
        url:
          'https://media.cntraveler.com/photos/53dabc296dec627b149fefbd/master/pass/pompano-beach-club-bermuda-bermuda-bermuda-101831-4.jpg'
      },
      {
        id: 2,
        currentPrice: 32,
      ...
      },
      {
        ...
        discount: 6,
        about: 'MUSEUMS',
        description: `Bermuda Mueseum of Natural History`,
        url:
      ...
      },
      {
        ...
        about: 'MEUSEUMS',
        highlight: `BEST SELLER`,
        description: `Bermuda Memorial & Meuseum Admission: Skip the Ticket Line`,
        url:
      ...
      },
      {
        ...
        discount: null,
        about: 'HOTELS',
        description: `Crown Heights`,
        url:
          'https://www.bermuda.com/wp-content/uploads/2021/12/regis-1.jpg'
      },
      {
        id: 7,
        currentPrice: 31,
        ...
        discount: 18,
        about: 'HOTELS',
        description: `Prince Charles`,
        url:
          'https://secure.s.forbestravelguide.com/img/properties/FTG_Hotel_ElbowBeachBermuda_GuestroomsandSuites_Bird-of-paradise-cottage-bedroom_CreditElbowBeachBermuda.jpg'
      },
      {
        id: 8,
        showMore: true,
...
const NewYorkData = [
  ...
  },
  {
    ...
    url:
      'https://stories.forbestravelguide.com/wp-content/uploads/2018/07/HERO-BermudaTop10-HorseshoeBay-CreditAndrewFKazmierski.jpg'
  },
  {
    id: 4,
    currentPrice: 28,
    ...
    discount: 20,
    about: 'PARK',
    description: 'Fantasy Cave',
    url:
      'https://www.planetware.com/photos-large/BER/bermuda-crystal-and-fantasy-caves.jpg'
  },
  {
    id: 5,
    currentPrice: 68,
    ...
    url:
      'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/1d/ca/c0/64/dolphin-quest-bermuda.jpg?w=500&h=400&s=1'
  },
  {
    id: 6,
    currentPrice: 49.14,
  ...
  },
  {
    ...
    url:
      'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/0c/3b/cd/43/royal-naval-dockyard.jpg?w=1200&h=-1&s=1'
  },
  {
    id: 9,
    currentPrice: 68,
    ...
    discount: 20,
    about: 'CRUISES',
    description: 'Bermuda Sightseeing Boat Tour',
    url:
  ...
  },
  {
    ...
    discount: 25,
    about: 'FUN',
    description: 'Nesta Park',
    url:
      'https://myfamilytravels.com/sites/default/files/Twizy.jpg'
  },
  {
    id: 11,
    currentPrice: 24,
