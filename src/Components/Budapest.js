...
import BudapestWeather from './BudapestW';
...
class Budapest extends Component {
        ...
        return (
            <div className="new-york-wrapper">
                    ...
                    <div className='newsWrapper ukmsg'>
                        ...
                        <div className='covidMsg'>
                            ...
                            <button className='btn'><span><GiWorld className='filler' /></span>
                                <span className='shift'>boc.gov.bp</span>
                            </button>
                        </div>
                    </div>
                ...
                <TopPicks className="tops" id="top"
                    headline={'Top Experiences in Budapest'}
...
const AllNewYorkCityData = [
...

    {
        ...
        description:
            'Get a taste of Budapest’s truly global culture with these delicious food tours of Budapest. Whether you’re looking for the best Budapest local cuisine or fancy the best craft beer from the east coast, we have got the perfect tours for you.',
        sectionData: [
            {
                id: 1,
                currentPrice: 61,
            ...
            },
            {
                ...
                cashback: null,
                about: 'FOOD AND DRINKS',
                description: `Sea Side Restaurant`,
                url:
                    'https://i.pinimg.com/originals/e1/19/8a/e1198aff78308abe7ff922437fdc9d8d.jpg'
            },
            {
                id: 3,
                currentPrice: 56,
                ...
                discount: 25,
                about: 'FOOD AND DRINKS',
                description: `Dunacorso Restaurant`,
                url:
                    'https://media-cdn.tripadvisor.com/media/photo-s/09/3e/f5/89/dunacorso-etterem.jpg'
            },
            {
                id: 4,
                currentPrice: 82,
                ...
                url:
                    'https://media.timeout.com/images/105277370/750/562/image.jpg'
            },
            {
                id: 5,
                currentPrice: 50,
                ...
                url:
                    'https://media.timeout.com/images/105454512/750/562/image.jpg'
            },
            {
                id: 6,
                currentPrice: 72,
                ...
                discount: 12,
                about: 'FOOD AND DRINKS',
                description: `Yesina Pesia `,
                url:
                    'https://media-cdn.tripadvisor.com/media/photo-s/0e/14/44/a6/hall.jpg'
            },
            {
                id: 7,
                currentPrice: 57,
                ...
                description: 'Bashee',
                url:
                    'https://pea-7f65.kxcdn.com/img/image_db/michelin_restaurants_in_florence-942.jpg'
            },
            {
                id: 8,
                showMore: true,
    ...
    {
        id: 4,
        headline: 'Budapest Tours',
        description:
            'With a range of tours catering to different parts of the city, you get the chance to see some of the major attractions. Check out our list of Budapest Tours to know more.',
        sectionData: [
            {
                id: 1,
                currentPrice: 33,
            ...
            },
            {
                ...
                about: 'BUDAPEST EXPLORER PASS',
                description: 'Budapest Explorer Pass - 3 Attractions',
                url:
            ...
            },
            {
                ...
                discount: 20,
                about: 'BUDAPEST TOURS',
                description: `Budapest in a Day`,
                url:
                    'https://mamalovesitaly.com/wp-content/uploads/2021/11/View-of-Florence-Italy.jpg'
            },
            {
                id: 4,
                currentPrice: 51,
            ...
            },
            {
                ...
                description: `Florence Observatory Entrance Tickets`,
                url:
                    'https://i.guim.co.uk/img/media/b8b2698cee07fa11ac048df455b49fd752ea9f7a/255_466_4869_2922/master/4869.jpg?width=1200&height=1200&quality=85&auto=format&fit=crop&s=3e41cbbc1737e954a544601ebb1d0291'
            },
            {
                id: 6,
                currentPrice: 124,
                ...
                about: 'THE BUDAPEST PASS',
                description: `Budapest Unlimited Attraction Pass - 1 Day`,
                url:
    ...
    {
        id: 7,
        headline: 'Budapest Museums and Hotels',
        description:
            'From museums that offer knowledge about art and history to five stars hotels, Budapest attractions have it all. Have a look at these to know more.',
        sectionData: [
            {
                id: 1,
                currentPrice: 37,
            ...
            },
            {
                ...
                discount: 6,
                about: 'MUSEUMS',
                description: `Budapest Mueseum of Natural History`,
                url:
            ...
            },
            {
                ...
                about: 'MEUSEUMS',
                highlight: `BEST SELLER`,
                description: `Captitan Meuseum Admission: Skip the Ticket Line`,
                url:
...
const NewYorkData = [
    {
        ...
        url:
            'https://www.planetware.com/photos-large/H/hungary-budapest-fishermans-bastion.jpg'
    },
    {
        id: 2,
        currentPrice: 35,
    ...
    },
    {
        ...
        description: 'Bona Estate',
        url:
            'https://urban-wanders.com/wp-content/uploads/2020/04/Fishermans-Bastion-The-Most-Instagrammable-Places-in-Budapest-e1587845543770.jpeg'
    },
    {
        id: 4,
        currentPrice: 28,
    ...
    },
    {
        ...
        url:
            'https://www.manvsglobe.com/wp-content/uploads/2018/07/DSCF3658.jpg'
    },
    {
        id: 6,
        currentPrice: 49.14,
        ...
        url:
            'https://www.touropia.com/gfx/b/2020/01/szechenyi_bath.jpg'
    },
    {
        id: 7,
        currentPrice: 57,
    ...
    },
    {
        ...
        url:
            'https://www.touropia.com/gfx/b/2020/01/liberty_bridge.jpg'
    },
    {
        id: 12,
        currentPrice: 28,
