...
import SingaporeWeather from './SingaporeW';
    ...
    return (
      <div className="new-york-wrapper">
        ...
        <div className='news'>
          <div className='newsWrapper'>
            ...
            <div className='covidMsg'>
              ...
              <p className='writeTravel'>Destination closed to entry. Exceptions may apply.</p>
              <button className='btn'><span><GiWorld className='filler' /></span>
                <span className='shift'>ica.gov.sg</span>
              </button>
            </div>
          </div>
        ...
        <TopPicks className="tops" id="top"
          headline={'Top Experiences in Singapore'}
...
const AllNewYorkCityData = [
  ...
  
  {
    ...
    description:
      'Get a taste of Singapore’s truly global culture with these delicious food tours of Singapore. Whether you’re looking for the best Singapore local cuisine or fancy the best craft beer from the east coast, we have got the perfect tours for you.',
    sectionData: [
      {
        id: 1,
        currentPrice: 61,
        ...
        description: 'Koma, Tales & Tastes',
        url:
          'https://media-cdn.tripadvisor.com/media/photo-s/18/e9/3b/29/koma-main-dining-room.jpg'
      },
      {
        id: 2,
        currentPrice: 60,
        ...
        description: `Capino`,
        url:
          'https://media.timeout.com/images/105757491/image.jpg'
      },
      {
        id: 3,
        currentPrice: 56,
  ...
  {
    id: 4,
    headline: 'Singapore Tours',
    description:
      'With a range of tours catering to different parts of the city, you get the chance to see some of the major attractions. Check out our list of Singapore Tours to know more.',
    sectionData: [
      {
        id: 1,
        currentPrice: 33,
      ...
      },
      {
        ...
        about: 'SINGAPORE EXPLORER PASS',
        description: 'Singapore Explorer Pass - 3 Attractions',
        url:
      ...
      },
      {
        ...
        discount: 20,
        about: 'SINGAPORE TOURS',
        description: `Singapore in a Day`,
        url:
      ...
      },
      {
        ...
        about: 'THE SINGAPORE PASS',
        description: `Singapore Unlimited Attraction Pass - 1 Day`,
        url:
  ...
  {
    id: 7,
    headline: 'Singapore Museums and Hotels',
    description:
      'From museums that offer knowledge about art and history to five stars hotels, Singapore attractions have it all. Have a look at these to know more.',
    sectionData: [
      {
        id: 1,
        currentPrice: 37,
      ...
      },
      {
        ...
        discount: 6,
        about: 'MUSEUMS',
        description: `Singapore Mueseum of Natural History`,
        url:
...
const NewYorkData = [
  ...
  },
  {
    ...
    description: 'Best of Singapore Tours',
    url:
      'https://a.cdn-hotels.com/gdcs/production53/d1468/128397b0-57d2-4183-b9fb-bf6a5254d19c.jpg'
  },
  {
    id: 4,
    currentPrice: 28,
  ...
  },
  {
    ...
    description: 'Market Food and Culture Walking Tour',
    url:
  ...
  },
  {
    ...
    about: 'ARCHITECTURE',
    discount: 20,
    description: 'Architecture of Singapore',
    url:
      'https://cdn.tourradar.com/s3/tour/645x430/192132_5e2aa4c92f661.jpg'
  },
  {
    id: 9,
    currentPrice: 68,
