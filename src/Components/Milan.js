...
import MilanWeather from './MilanWeather';
        ...
        return (
            <div className="new-york-wrapper">
                ...
                <TopPicks className="tops" id="top"
                    headline={'Top Experiences in Milan'}
...
const AllNewYorkCityData = [
...

    {
        ...
        description:
            'Get a taste of Milan’s truly global culture with these delicious food tours of Milan. Whether you’re looking for the best Milan local cuisine or fancy the best craft beer from the east coast, we have got the perfect tours for you.',
        sectionData: [
            {
                id: 1,
                currentPrice: 61,
    ...
    {
        id: 4,
        headline: 'Milan Tours',
        description:
            'With a range of tours catering to different parts of the city, you get the chance to see some of the major attractions. Check out our list of Milan Tours to know more.',
        sectionData: [
            {
                id: 1,
                currentPrice: 33,
                ...
                url:
                    'https://www.touring-italy.net/images/tours/2016/152-maschio-angioino-2.jpg'
            },
            {
                id: 2,
                currentPrice: 86,
                ...
                about: 'MILAN EXPLORER PASS',
                description: 'Milan Explorer Pass - 3 Attractions',
                url:
            ...
            },
            {
                ...
                url:
                    'https://cdn.getyourguide.com/img/tour/54ad03757cca6.jpeg/99.jpg'
            },
            {
                id: 5,
                currentPrice: 35,
                ...
                description: `Milan Observatory Entrance Tickets`,
                url:
            ...
            },
            {
                ...
                about: 'THE MILAN PASS',
                description: `Milan Unlimited Attraction Pass - 1 Day`,
                url:
    ...
    {
        id: 7,
        headline: 'Milan Museums and Hotels',
        description:
            'From museums that offer knowledge about art and history to five stars hotels, Milan attractions have it all. Have a look at these to know more.',
        sectionData: [
            {
                id: 1,
                currentPrice: 37,
            ...
            },
            {
                ...
                discount: 6,
                about: 'MUSEUMS',
                description: `Milan Mueseum of Natural History`,
                url:
...
const NewYorkData = [
    {
        ...
        url:
            'https://media.tacdn.com/media/attractions-splice-spp-674x446/07/35/6a/60.jpg'
    },
    {
        id: 2,
        currentPrice: 35,
