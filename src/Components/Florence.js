...
import FlorenceWeather from './FlorenceWeather';
        ...
        return (
            <div className="new-york-wrapper">
                ...
                <TopPicks className="tops" id="top"
                    headline={'Top Experiences in Florence'}
...
const AllNewYorkCityData = [
...

    {
        ...
        description:
            'Get a taste of Florence’s truly global culture with these delicious food tours of Florence. Whether you’re looking for the best Florence local cuisine or fancy the best craft beer from the east coast, we have got the perfect tours for you.',
        sectionData: [
            {
                id: 1,
                currentPrice: 61,
                ...
                description: 'El Grigo',
                url:
                    'https://media.timeout.com/images/105454525/750/562/image.jpg'
            },
            {
                id: 2,
                currentPrice: 60,
            ...
            },
            {
                ...
                url:
                    'https://traveler.marriott.com/wp-content/uploads/2019/03/GI_1130661502_FlorenceTrattoria.jpg'
            },
            {
                id: 5,
                currentPrice: 50,
    ...
    {
        id: 4,
        headline: 'Florence Tours',
        description:
            'With a range of tours catering to different parts of the city, you get the chance to see some of the major attractions. Check out our list of Florence Tours to know more.',
        sectionData: [
            {
                id: 1,
                currentPrice: 33,
            ...
            },
            {
                ...
                about: 'FLORENCE EXPLORER PASS',
                description: 'Florence Explorer Pass - 3 Attractions',
                url:
            ...
            },
            {
                ...
                about: 'THE FLORENCE PASS',
                description: `Florence Unlimited Attraction Pass - 1 Day`,
                url:
    ...
    {
        id: 7,
        headline: 'Florence Museums and Hotels',
        description:
            'From museums that offer knowledge about art and history to five stars hotels, Florence attractions have it all. Have a look at these to know more.',
        sectionData: [
            {
                id: 1,
                currentPrice: 37,
