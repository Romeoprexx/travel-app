...
import SydneyWeather from './SydneyW';
    ...
    return (
      <div className="new-york-wrapper">
          ...
          <div className='newsWrapper'>
            ...
            <div className='covidMsg'>
              ...
              <button className='btn'><span><GiWorld className='filler' /></span>
                <span className='shift'>homeaffairs.gov.au</span>
              </button>
            </div>
          </div>
        ...
        <TopPicks className="tops" id="top"
          headline={'Top Experiences in Sydney'}
...
const AllNewYorkCityData = [
  ...
  
  {
    ...
    description:
      'Get a taste of Sydney’s truly global culture with these delicious food tours of Sydney. Whether you’re looking for the best Sydney local cuisine or fancy the best craft beer from the east coast, we have got the perfect tours for you.',
    sectionData: [
      {
        id: 1,
        currentPrice: 61,
      ...
      },
      {
        ...
        discount: 25,
        about: 'FOOD AND DRINKS',
        description: `Rockpool Bar`,
        url:
          'https://media.cntraveler.com/photos/5cd39c57e53fb51a2d16ccc2/master/w_4000,h_3005,c_limit/The-Pink-Beach-Club_PBC-to-the-South-East-1.jpg'
      },
      {
        id: 4,
        currentPrice: 82,
        ...
        cashback: 40,
        about: 'FOOD AND DRINKS',
        description: `The Original NSW Pizza`,
        url:
      ...
      },
      {
        ...
        discount: 12,
        about: 'FOOD AND DRINKS',
        description: `Bopp Tone Restaurant`,
        url:
  ...
  {
    id: 4,
    headline: 'Sydney Tours',
    description:
      'With a range of tours catering to different parts of the city, you get the chance to see some of the major attractions. Check out our list of Sydney Tours to know more.',
    sectionData: [
      {
        id: 1,
        currentPrice: 33,
      ...
      },
      {
        ...
        about: 'SYDNEY EXPLORER PASS',
        description: 'Sydney Explorer Pass - 3 Attractions',
        url:
      ...
      },
      {
        ...
        about: 'THE SYDNEY PASS',
        description: `Sydney Unlimited Attraction Pass - 1 Day`,
        url:
  ...
  {
    id: 7,
    headline: 'Sydney Museums and Hotels',
    description:
      'From museums that offer knowledge about art and history to five stars hotels, Sydney attractions have it all. Have a look at these to know more.',
    sectionData: [
      {
        id: 1,
        currentPrice: 37,
      ...
      },
      {
        ...
        discount: 6,
        about: 'MUSEUMS',
        description: `NSW Mueseum of Natural History`,
        url:
      ...
      },
      {
        ...
        about: 'MEUSEUMS',
        highlight: `BEST SELLER`,
        description: `Aussie Memorial & Meuseum Admission: Skip the Ticket Line`,
        url:
...
const NewYorkData = [
  ...
  },
  {
    ...
    url:
      'https://i.insider.com/59aef78252c08047008b4b80?width=600&format=jpeg&auto=webp'
  },
  {
    id: 4,
    currentPrice: 28,
  ...
  },
  {
    ...
    discount: 20,
    about: 'ARCHITECTURE',
    description: 'Sydney Tour',
    url:
      'https://www.planetware.com/photos-large/AUS/australia-sydney-circular-quay.jpg'
  },
  {
    id: 6,
    currentPrice: 49.14,
  ...
  },
  {
    ...
    url:
      'https://thoth.pickvisa.com/wp-content/uploads/2021/12/7a1857931ba446efa22650e16d122fbd.jpg'
  },
  {
    id: 9,
    currentPrice: 68,
    ...
    discount: 20,
    about: 'CRUISES',
    description: 'Sydney Sightseeing Boat Tour',
    url:
