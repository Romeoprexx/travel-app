...
import NaplesWeather from './NaplesWeather';
        ...
        return (
            <div className="new-york-wrapper">
                ...
                <TopPicks className="tops" id="top"
                    headline={'Top Experiences in Naples'}
...
const AllNewYorkCityData = [
...

    {
        ...
        description:
            'Get a taste of Naple’s truly global culture with these delicious food tours of Naples. Whether you’re looking for the best Naples local cuisine or fancy the best craft beer from the east coast, we have got the perfect tours for you.',
        sectionData: [
            {
                id: 1,
                currentPrice: 61,
    ...
    {
        id: 4,
        headline: 'Naples Tours',
        description:
            'With a range of tours catering to different parts of the city, you get the chance to see some of the major attractions. Check out our list of Naples Tours to know more.',
        sectionData: [
            {
                id: 1,
                currentPrice: 33,
            ...
            },
            {
                ...
                about: 'NAPLES EXPLORER PASS',
                description: 'Naples Explorer Pass - 3 Attractions',
                url:
            ...
            },
            {
                ...
                description: `Naples Observatory Entrance Tickets`,
                url:
            ...
            },
            {
                ...
                about: 'THE NAPLES PASS',
                description: `Naples Unlimited Attraction Pass - 1 Day`,
                url:
    ...
    {
        id: 7,
        headline: 'Naples Museums and Hotels',
        description:
            'From museums that offer knowledge about art and history to five stars hotels, Naples attractions have it all. Have a look at these to know more.',
        sectionData: [
            {
                id: 1,
                currentPrice: 37,
            ...
            },
            {
                ...
                discount: 6,
                about: 'MUSEUMS',
                description: `Naples Mueseum of Natural History`,
                url:
