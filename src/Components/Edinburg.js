...
import EdinburgWeather from './EdinburgW';
        ...
        return (
            <div className="new-york-wrapper">
                ...
                <div className='news'>
                    <div className='newsWrapper ukmsg'>
                        ...
                        <div className='covidMsg'>
                            ...
                            <p className='writeTravel'>London COVID-19 travel updates<br />

                                62% of flights are operating <br />

                                39% of hotels have availability</p>
                            <button className='btn'><span><GiWorld className='filler' /></span>
                                <span className='shift'>cdc.gov.uk</span>
                            </button>
                        </div>
                    </div>
                ...
                <TopPicks className="tops" id="top"
                    headline={'Top Experiences in Edinburgh'}
...
const backgroundImagesData = [
    ...
    },
    {
        id: 2,
        url:
            'https://media.timeout.com/images/103938223/750/422/image.jpg'
    },
    {
        id: 3,
        url:
    ...
    },
    {
        id: 5,
        url:
            'https://static.standard.co.uk/s3fs-public/thumbnails/image/2020/07/30/09/3007pixday-1.jpg?width=1200'
    },
    {
        id: 6,
        url:
...
const AllNewYorkCityData = [
...

    {
        ...
        description:
            'Get a taste of Edinburgh’s truly global culture with these delicious food tours of Edinburgh. Whether you’re looking for the best Edinburgh local cuisine or fancy the best craft beer from the east coast, we have got the perfect tours for you.',
        sectionData: [
            {
                id: 1,
                currentPrice: 61,
                ...
                description: 'Edins, Tales & Tastes',
                url:
            ...
            },
            {
                ...
                cashback: null,
                about: 'FOOD AND DRINKS',
                description: `Ricketts Restaurant`,
                url:
            ...
            },
            {
                ...
                discount: 25,
                about: 'FOOD AND DRINKS',
                description: `Halvin Restaurant`,
                url:
                    'https://media.cntraveler.com/photos/5a8cb5714ff8184d0cc2dadf/master/w_4000,h_2667,c_limit/Jaan_2018_JAAN.jpg'
            },
            {
                id: 4,
                currentPrice: 82,
            ...
            },
            {
                ...
                discount: 12,
                about: 'FOOD AND DRINKS',
                description: `Edinburghs Beer Festival`,
                url:
    ...
    {
        id: 4,
        headline: 'Edinburgh Tours',
        description:
            'With a range of tours catering to different parts of the city, you get the chance to see some of the major attractions. Check out our list of Edinburgh Tours to know more.',
        sectionData: [
            {
                id: 1,
                currentPrice: 33,
                ...
                cashback: null,
                discount: 5,
                about: 'EDINBURGH TOURS',
                description: 'The Tour',
                url:
                    'https://www.goscotlandtours.com/uploads/images/products/large/1458-edinburgh-ghost-bus.jpg'
            },
            {
                id: 2,
                currentPrice: 86,
                ...
                about: 'EDINBURGH EXPLORER PASS',
                description: 'Edinburgh Explorer Pass - 3 Attractions',
                url:
                    'https://i.ytimg.com/vi/bAgkeogi_5E/maxresdefault.jpg'
            },
            {
                id: 3,
                currentPrice: 134.4,
                ...
                discount: 20,
                about: 'EDINBURGH TOURS',
                description: `Edinburgh in a Day`,
                url:
                    'https://www.edinburghfestivalcity.com/assets/000/001/116/Planning_header_Attractions_original.jpg?1444663422'
            },
            {
                id: 4,
                currentPrice: 51,
                ...
                url:
                    'https://media.tacdn.com/media/attractions-splice-spp-674x446/06/6f/50/ac.jpg'
            },
            {
                id: 5,
                currentPrice: 35,
                ...
                description: `Edinburgh Observatory Entrance Tickets`,
                url:
            ...
            },
            {
                ...
                about: 'THE EDINBURGH PASS',
                description: `Edinburgh Unlimited Attraction Pass - 1 Day`,
                url:
    ...
    {
        id: 7,
        headline: 'Edinburgh Museums and Hotels',
        description:
            'From museums that offer knowledge about art and history to five stars hotels, Edinburgh attractions have it all. Have a look at these to know more.',
        sectionData: [
            {
                id: 1,
                currentPrice: 37,
            ...
            },
            {
                ...
                discount: 6,
                about: 'MUSEUMS',
                description: `Edinburgh Mueseum of Natural History`,
                url:
...
const NewYorkData = [
    {
        ...
        description: 'Warner Bros. Studio Tour London',
        url:
    ...
    },
    {
        ...
        description: 'View from the Edins Eye at night.',
        url:
    ...
    },
    {
        ...
        url:
            'https://edinburgh.org/media/1025/castle-at-night.jpg'
    },
    {
        id: 6,
        currentPrice: 49.14,
        ...
        discount: 20,
        about: 'PHOTO',
        description: 'Creyfriars.',
        url:
            'https://static.toiimg.com/photo/46501049.cms'
    },
    {
        id: 7,
        currentPrice: 57,
        ...
        url:
            'https://cdn.londonandpartners.com/-/media/images/london/visit/things-to-do/sightseeing/london-attractions/madame-tussauds/madame-tussauds-the-queen-640x360.jpg'
    },
    {
        id: 8,
        currentPrice: 288,
    ...
    },
    {
        ...
        discount: 25,
        about: 'ARCHITECTURE',
        description: 'Scotland’s most famous skyscrapers',
        url:
            'https://cdn.londonandpartners.com/visit/london-organisations/the-shard/65734-640x360-skyline-shard-640.jpg'
    },
    {
        id: 11,
        currentPrice: 24,
    ...
    },
    {
        ...
        url:
            'https://cdn.londonandpartners.com/visit/london-organisations/national-theatre/87134-640x360-nationaltheatre.jpg'
    },
    {
        id: 14,
        currentPrice: 29,
        ...
        description: `Romeo Castle tickets`,
        url:
            'https://media.30seconds.com/tip/lg/Edinburgh-Scotland-5-Family-Friendly-Attractions-You-Wont--16020-224923d31a-1521735767.jpg'
    },
    {
        id: 15,
        currentPrice: 69,
        ...
        discount: 46,
        about: 'BROADWAY TOURS',
        description: `King James Tower Tour`,
        url:
            'https://lp-ta.imgix.net/attractions-splice-spp-720x480/07/1e/84/eb.jpg'
    },
    {
        id: 16,
        currentPrice: 99,
        ...
        cashback: 10,
        about: 'BROADWAY TOURS',
        description: `Hop-on hop-off bus tour`,
        url:
            'https://cdn.londonandpartners.com/asset/hop-on-hop-off-bus-tour_golden-tours-hop-on-hop-off-bus-tour-at-the-london-eye-golden-tours_79082d0e65c390d7276650ec1ee66a97.jpg'
    },
    {
        id: 17,
        currentPrice: 49.5,
