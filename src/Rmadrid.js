...
import MadridWeather from './MadridWeather';
...
class Rmadrid extends Component {
        ...
        return (
            <div className="new-york-wrapper">
                ...
                <TopPicks className="tops" id="top"
                    headline={'Top Experiences in Madrid'}
...
const AllNewYorkCityData = [
...

    {
        ...
        description:
            'Get a taste of Madrid’s truly global culture with these delicious food tours of Madrid. Whether you’re looking for the best Madrid local cuisine or fancy the best craft beer from the east coast, we have got the perfect tours for you.',
        sectionData: [
            {
                id: 1,
                currentPrice: 61,
    ...
    {
        id: 4,
        headline: 'Madrid Tours',
        description:
            'With a range of tours catering to different parts of the city, you get the chance to see some of the major attractions. Check out our list of Madrid Tours to know more.',
        sectionData: [
            {
                id: 1,
                currentPrice: 33,
            ...
            },
            {
                ...
                about: 'MADRID EXPLORER PASS',
                description: 'Madrid Explorer Pass - 3 Attractions',
                url:
            ...
            },
            {
                ...
                description: `Madrid Observatory Entrance Tickets`,
                url:
            ...
            },
            {
                ...
                about: 'THE MADRID PASS',
                description: `Madrid Unlimited Attraction Pass - 1 Day`,
                url:
    ...
    {
        id: 7,
        headline: 'Madrid Museums and Hotels',
        description:
            'From museums that offer knowledge about art and history to five stars hotels, Madrid attractions have it all. Have a look at these to know more.',
        sectionData: [
            {
                id: 1,
                currentPrice: 37,
            ...
            },
            {
                ...
                discount: 6,
                about: 'MUSEUMS',
                description: `Madrid Mueseum of Natural History`,
                url:
